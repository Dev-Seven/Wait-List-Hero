      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Edit Stylist</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Stylist</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form method="post" action="{{route('admin.stylist.update')}}" id="stylist_update_form">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" value="{{$data->company_name}}" name="company_name" class="form-control" placeholder="Company Name">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label">Email</label>
                        <input type="text" value="{{$data->email}}" class="form-control" placeholder="Email" readonly="readonly">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
