      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Create Admin</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{route('admin.user.store')}}" id="admin_create_form">
                @csrf
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group text-right">
                        <a href="{{route('admin.user.index')}}" class="btn btn_loader btn-danger">Cancel</a>
