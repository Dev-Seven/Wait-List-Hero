...
<div class="header-body">
  <div class="row align-items-center py-4">
    <div class="col-lg-6 col-7">
      <h6 class="h2 text-white d-inline-block mb-0">Admin Detail</h6>
    </div>
    <div class="col-lg-6 col-7 text-right">
      <a href="{{route('admin.user.index')}}" class="btn btn_loader btn-success">Back</a>
    </div>
  </div>
</div>
</div>
        ...
        <div class="table-responsive">
          ...
          <table class="table align-items-center table-flush">
            <tbody>
              ...
              <tr>
                <th>Role</th>
                <td>@if($data->role == 1) <strong>Super Admin</strong> @else <strong>Admin</strong> @endif</td>
              </tr>
              <tr>
                <th>Status</th>
