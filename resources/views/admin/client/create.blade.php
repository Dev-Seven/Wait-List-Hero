      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Create Client</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{route('admin.client.store')}}" id="client_create_form">
                @csrf
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group text-right">
                        <a href="{{route('admin.client.index')}}" class="btn loader_class btn-danger">Cancel</a>
