      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Edit Client</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
              <form method="post" action="{{route('admin.client.update')}}" id="client_update_form">
                @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group text-right">
                        <a href="{{route('admin.client.index')}}" class="btn btn_loader btn-danger">Cancel</a>
